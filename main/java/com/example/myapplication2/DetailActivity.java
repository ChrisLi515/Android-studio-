...
public class DetailActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView tv_title,tv_createtime,tv_note;
    ...
    public void initEvent(){
        ...
        Cursor cursor= mDatabase.query(DBHelper.TABLE_NAME,DBHelper.TABLE_information,"id=?",new String[]{id+""},null,null,null,null);
        while (cursor != null && cursor.moveToNext()) {
            tv_title.setText(cursor.getString(cursor.getColumnIndex(DBHelper.COLUMN_TITTLE)));
            tv_createtime.setText(cursor.getString(cursor.getColumnIndex(DBHelper.COLUMN_CREATETIME)));
            tv_note.setText(cursor.getString(cursor.getColumnIndex(DBHelper.COLUMN_NOTE)));
        }
        cursor.close();
    ...
    private void queryTitle() {
        ...
        cursor1.close();
        Cursor cursor;
        cursor = mDatabase.query(DBHelper.TABLE_NAME,DBHelper.TABLE_information,null,null,null,null,null,null);
        int i=0;
        while (cursor != null && cursor.moveToNext()) {
